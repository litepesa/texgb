// lib/main_screen/home_screen.dart (FINAL VERSION - 3 TABS)
...
class _HomeScreenState extends ConsumerState<HomeScreen>
  ...
  Widget _buildComingSoonScreen(String title, IconData icon, ModernThemeExtension modernTheme) {
    return Container(
    ...
    return Scaffold(
      ...
      body: PageView(
        ...
        children: [
          ...
          _KeepAliveWrapper(
            child: Builder(
              builder: (context) => _buildComingSoonScreen(
                'Chats',
          ...
          // Users/Shops tab (index 2) - Users List Screen
          _KeepAliveWrapper(
  ...
  Widget _buildFab(ModernThemeExtension modernTheme) {
    if (_currentIndex == 0) {
      ...
      // Users/Shops tab - Navigate to create post screen
      return FloatingActionButton(
        backgroundColor: modernTheme.backgroundColor,
        foregroundColor: modernTheme.primaryColor,
        elevation: 4,
