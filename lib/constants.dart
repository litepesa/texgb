...
class Constants {
  ...
  static const String videosFeedScreen =
      '/videosFeed'; // was channelsFeedScreen
  static const String singleVideoScreen =
      '/singleVideo'; // was channelFeedScreen

  // User Profile Routes
  static const String createProfileScreen =
      '/createProfile'; // was createChannelScreen
  static const String myProfileScreen = '/myProfile'; // was myChannelScreen
  static const String userProfileScreen =
      '/userProfile'; // was channelProfileScreen
  static const String editProfileScreen =
      '/editProfile'; // was editChannelScreen
  ...
  static const String createPostScreen =
      '/createPost'; // was createChannelPostScreen
  ...
  static const String likedVideosKey =
      'likedVideos'; // was 'likedChannelVideos'
  static const String followedUsersKey =
      'followedUsers'; // was 'followedChannels'
  ...
  static const String searchSuggestionsEndpoint =
      '$baseApiUrl/videos/search/suggestions';
  static const String popularSearchTermsEndpoint =
      '$baseApiUrl/videos/search/popular';
  ...
  static const int maxVideosPerCategory =
      100; // Maximum videos to load per category
  ...
  static const String guestModePrompt =
      'Create an account to like, comment, and share videos';
  static const String guestModeUploadPrompt =
      'Sign in to upload your own videos';
  static const String guestModeFollowPrompt =
      'Sign in to follow your favorite creators';
  static const String guestModeCommentPrompt =
      'Sign in to join the conversation';

  // 🆕 NEW: Search Guest Mode Messages
  static const String guestModeSearchRestriction =
      'Sign in for advanced search features';
  static const String guestModeSearchHistoryPrompt =
      'Sign in to save your search history';
  static const String guestModeSearchFiltersPrompt =
      'Sign in to save custom search filters';
  ...
  static const String notificationPriceAlert =
      'price_alert'; // NEW: Price alert notification
  static const String notificationCategoryTrending =
      'category_trending'; // NEW: Category trending notification
  ...
  static const String playStoreId =
      'com.weibao.app'; // Replace with actual Play Store ID
  ...
  static bool isValidSearchQuery(String query) {
    ...
    return trimmed.isNotEmpty &&
        ...
        !bannedSearchTerms.any(
            (banned) => trimmed.toLowerCase().contains(banned.toLowerCase()));
  }
  ...
  static bool isTrendingSearchQuery(String query, List<String> trendingTerms) {
    return trendingTerms
        .any((term) => term.toLowerCase() == query.toLowerCase());
  }
  ...
  static String getSearchFilterDisplayName(
  ...
  static String generateUniqueId() {
    return DateTime.now().millisecondsSinceEpoch.toString() +
        (1000 + (999999 - 1000) * (DateTime.now().microsecond / 1000000))
            .round()
            .toString();
  }
...
extension ConstantsExtension on Constants {
  ...
  static bool get isSearchSuggestionsEnabled =>
      Constants.enableSearchSuggestions;
