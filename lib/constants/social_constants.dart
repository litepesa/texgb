...
class GroupConstants {
  ...
  static const int maxModerators =
      100; // Maximum number of moderators per group
...
class StatusConstants {
  ...
  static const Duration statusDisplayDuration =
      Duration(seconds: 5); // Auto-advance
...
class SocialErrorMessages {
  ...
  static const String messageTooLong =
      'Message is too long. Maximum ${ChatConstants.maxMessageLength} characters.';
  static const String mediaFileTooLarge = 'File is too large. Maximum size is ';
  static const String videoTooLong =
      'Video is too long. Maximum ${ChatConstants.maxVideoDuration ~/ 60} minutes.';
  static const String audioTooLong =
      'Audio is too long. Maximum ${ChatConstants.maxAudioDuration ~/ 60} minutes.';
  ...
  static const String groupNameTooLong =
      'Group name is too long. Maximum ${GroupConstants.maxGroupNameLength} characters.';
  static const String groupDescriptionTooLong =
      'Description is too long. Maximum ${GroupConstants.maxGroupDescriptionLength} characters.';
  static const String groupFull =
      'This group has reached the maximum number of members (${GroupConstants.maxMembers}).';
  static const String notGroupAdmin =
      'You need to be an admin to perform this action.';
  static const String notGroupModerator =
      'You need to be a moderator or admin to perform this action.';
  static const String cannotLeaveAsOnlyAdmin =
      'You cannot leave the group as the only admin. Please assign another admin first.';
  static const String groupCreateFailed =
      'Failed to create group. Please try again.';

  // Status errors
  static const String statusTooLong =
      'Status is too long. Maximum ${StatusConstants.maxVideoStatusDuration ~/ 60} minutes.';
  static const String statusFileTooLarge =
      'Status file is too large. Maximum ${StatusConstants.maxStatusFileSize ~/ (1024 * 1024)} MB.';
  static const String textStatusTooLong =
      'Text is too long. Maximum ${StatusConstants.maxTextStatusLength} characters.';
  static const String statusUploadFailed =
      'Failed to upload status. Please try again.';
  static const String statusExpired = 'This status has expired.';
  static const String maxStatusReached =
      'You have reached the maximum number of status updates for today.';
