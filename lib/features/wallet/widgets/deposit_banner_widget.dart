// lib/features/wallet/widgets/deposit_banner_widget.dart
...
class _DepositBannerWidgetState extends ConsumerState<DepositBannerWidget>
  ...
  Widget build(BuildContext context) {
    ...
    // Only show if balance is exactly 0 (or forceShow is true)
    if (!widget.forceShow && balance != 0) {
...
class DepositBannerCard extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<DepositBannerCard> createState() => _DepositBannerCardState();
}

class _DepositBannerCardState extends ConsumerState<DepositBannerCard>
    with SingleTickerProviderStateMixin {
  late AnimationController _bannerAnimationController;
  late Animation<double> _bannerAnimation;
