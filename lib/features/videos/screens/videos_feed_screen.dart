...
class VideosFeedScreenState extends ConsumerState<VideosFeedScreen>
  ...
  bool _isScreenActive =
      false; // Start as false since wallet tab is initial screen
  ...
  void _onVideoControllerReady(VideoPlayerController controller) {
    ...
    controller.addListener(() {
      if (mounted && controller.value.isInitialized) {
        ...
        ref.read(isVideoPlayingProvider.notifier).state =
    ...
    return PageView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        return VideoItem(
          ...
          isFeedScreen: true,
          // Pass callback to show comments with small video window
