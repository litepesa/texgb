...
class StatusNotifier extends _$StatusNotifier {
  ...
  Future<void> sendStatusReply({
    ...
    try {
      ...
      // Use await here to ensure the operation completes or throws
      ...
      // Only update state if the operation completes successfully
      if (state.hasValue) {
        state = AsyncValue.data(state.value!.copyWith(
          isLoading: false,
        ));
      ...
      // Rethrow but wrapped in a more specific exception to help with debugging
