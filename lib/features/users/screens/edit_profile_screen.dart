...
class _EditProfileScreenState extends ConsumerState<EditProfileScreen> {
  ...
  void initState() {
    ...
    String mpesaDisplay = '';
    if (currentUser?.mpesaNumber != null &&
        currentUser!.mpesaNumber!.isNotEmpty) {
              ...
              children: [
                ...
                if ((isProfileImage &&
                        (currentUser?.profileImage.isNotEmpty == true ||
                            _isProfileImageChanged)) ||
                    (!isProfileImage &&
                        (currentUser?.coverImage.isNotEmpty == true ||
                            _isCoverImageChanged)))
                  _buildImageOption(
                    icon: Icons.delete,
                    label: 'Remove',
                    onTap: () {
      ...
      if (_mpesaController.text.trim().isNotEmpty) {
        ...
        if (formattedMpesa == null) {
          showSnackBar(context,
              'Please enter a valid Kenyan mobile number (e.g., 0712345678 or 0112345678)');
          return;
        }
      }
            ...
            children: [
                ...
                Column(
                  children: [
                    LinearProgressIndicator(
                      backgroundColor:
                          modernTheme.surfaceColor?.withOpacity(0.3),
              ...
              TextFormField(
                ...
                decoration: InputDecoration(
                  ...
                  helperText:
                      '${_nameController.text.length}/${Constants.maxNameLength}',
              ...
              TextFormField(
                ...
                decoration: InputDecoration(
                  ...
                  fillColor: modernTheme.surfaceColor?.withOpacity(0.3),
                  helperText:
                      '${_aboutController.text.length}/${Constants.maxAboutLength}',
                  helperStyle: TextStyle(
                    color: modernTheme.textSecondaryColor?.withOpacity(0.7),
                    fontSize: 12,
                  ),
              ...
              TextFormField(
                ...
                decoration: InputDecoration(
                  ...
                  helperText:
                      'Your M-Pesa number for receiving payments (254XXXXXXXXX format)',
                  helperStyle: TextStyle(
                    color: modernTheme.textSecondaryColor?.withOpacity(0.7),
                    fontSize: 12,
                  ),
                ...
                inputFormatters: [
                  ...
                  LengthLimitingTextInputFormatter(
                      10), // Limit to 10 digits for local format
                ],
                enabled: !isLoading,
                validator: (value) {
  ...
  DecorationImage? _getProfileImageProvider() {
    ...
    } else if (!_isProfileImageChanged &&
        currentUser?.profileImage.isNotEmpty == true) {
      return DecorationImage(
