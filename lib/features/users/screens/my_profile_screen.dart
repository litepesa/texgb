...
import 'package:textgb/features/users/widgets/privacy_settings_widget.dart';
...
class _MyProfileScreenState extends ConsumerState<MyProfileScreen> {
  ...
  Widget _buildMenuGroup(
      ModernThemeExtension modernTheme, List<_MenuItem> items) {
    return Container(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            ...
            const SizedBox(height: 16),
            Text(
              'WohZuh connecting you with who and what really matters!',
              style: TextStyle(
                color: modernTheme.textColor,
                fontSize: 14,
                height: 1.5,
