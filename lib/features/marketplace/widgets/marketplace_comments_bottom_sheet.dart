// lib/features/marketplace/widgets/marketplace_comments_bottom_sheet.dart
...
class _MarketplaceCommentsBottomSheetState extends ConsumerState<MarketplaceCommentsBottomSheet>
  ...
  void _deleteComment(MarketplaceCommentModel comment) {
    showDialog(
      context: context,
...
class CommentGroup {
  final MarketplaceCommentModel mainComment;
  final List<MarketplaceCommentModel> replies;
