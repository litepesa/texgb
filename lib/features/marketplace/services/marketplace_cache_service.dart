...
class MarketplaceCacheService {
  ...
  Uri getLocalUri(String videoUrl) {
    ...
    try {
      ...
      debugPrint('MarketplaceCacheService: Converted $videoUrl to $localUri');
  ...
  Future<bool> precacheVideo(
    ...
    if (_cachingVideos.contains(videoUrl)) {
      debugPrint('MarketplaceCacheService: Already precaching $videoUrl');
      return false;
    }
    ...
    try {
      ...
      debugPrint('MarketplaceCacheService: Started precaching $videoUrl');
      return true;
    } catch (e) {
      debugPrint('MarketplaceCacheService: Failed to precache $videoUrl - $e');
  ...
  void clearVideoTracking(String videoUrl) {
    ...
    debugPrint('MarketplaceCacheService: Cleared tracking for $videoUrl');
  }
...
extension MarketplaceCachingStringExtension on String {
  ...
  Future<bool> precache({
    ...
    return MarketplaceCacheService().precacheVideo(
      this,
      cacheSegments: cacheSegments,
    );
  }
