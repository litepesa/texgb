...
import 'package:textgb/features/channels/widgets/search_overlay.dart';
// Import video progress provider
import 'package:textgb/features/channels/providers/video_progress_provider.dart';
  ...
  UserModel? _getUserDataIfAvailable() {
    ...
    try {
      ...
      return users.firstWhere(
        (user) => user.uid == currentVideo.channelId,
      );
    } catch (e) {
      return null;
    }
