...
class _CreateChannelScreenState extends ConsumerState<CreateChannelScreen> {
  ...
  void _submitForm() {
    if (_formKey.currentState!.validate()) {
      ...
      // Get current authentication state to get user info
      ...
      if (uid == null) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text('User not authenticated. Please sign in first.')),
        );
        return;
      }
      ...
      final channelModel = ChannelModel(
        ...
        ownerId: uid,
        ownerName: _nameController.text, // Using channel name as owner name initially
        ownerImage: '', // Will be set after upload
      ...
      authNotifier.saveChannelDataToFireStore(
        ...
        onFail: () {
          ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(content: Text('Failed to create channel. Please try again.')),
          );
        },
      );
    }
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              ...
              GestureDetector(
                onTap: authState.isLoading ? null : _pickCoverImage,
                child: Container(
                  height: 150,
              ...
              Center(
                child: GestureDetector(
                  onTap: authState.isLoading ? null : _pickProfileImage,
                  child: Container(
                    width: 100,
                    height: 100,
                    decoration: BoxDecoration(
