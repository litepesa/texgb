...
class ChannelPost {
  ...
  factory ChannelPost.fromJson(Map<String, dynamic> json) {
    ...
    if (json['imageUrls'] != null) {
      ...
      imageUrls = (json['media_urls'] as List<dynamic>)
          .map((e) => e as String)
          .toList();
    }
    ...
    return ChannelPost(
      ...
      channelName:
          json['channelName'] as String? ?? json['channel_name'] as String?,
      channelAvatarUrl: json['channelAvatarUrl'] as String? ??
          json['channel_avatar_url'] as String?,
      ...
      contentType: _postContentTypeFromString(
      ...
      previewDuration: json['previewDuration'] as int? ??
          json['preview_duration'] as int? ??
          json['previewDurationSeconds'] as int? ??
          json['preview_duration_seconds'] as int?,
      ...
      unlocksCount: json['unlocksCount'] as int? ??
          json['unlocks_count'] as int? ??
          json['unlocks'] as int? ??
          0,
      sharesCount:
          json['sharesCount'] as int? ?? json['shares_count'] as int? ?? 0,
...
extension ChannelPostExtension on ChannelPost {
  ...
  bool get hasPreview =>
      isPremium && previewDuration != null && previewDuration! > 0;
...
class ChannelUnlock {
  ...
  factory ChannelUnlock.fromJson(Map<String, dynamic> json) {
    return ChannelUnlock(
      ...
      creatorEarned:
          json['creatorEarned'] as int? ?? json['creator_earned'] as int,
