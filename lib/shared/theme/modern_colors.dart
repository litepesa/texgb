...
class ModernColors {
  ...
  static const primaryTeal = Color(
      0xFF25D366); // Updated light theme green with the same green as dark mode
  static const accentBlue =
      Color(0xFF53BDEB); // Accent blue for dark mode (unchanged)
  static const accentTealBlue =
      Color(0xFF056062); // Updated accent blue for light mode

  // Semantic colors
  static const success =
      Color(0xFF25D366); // Success actions/states (unchanged)
  static const warning =
      Color(0xFFFFA000); // Warning actions/states (unchanged)
  static const error = Color(0xFFE55252); // Error actions/states (unchanged)
  static const info =
      Color(0xFF53BDEB); // Information actions/states (unchanged)

  // Group-specific semantic colors (replacing hardcoded colors)
  static const groupAdmin =
      Color(0xFF53BDEB); // Admin role badge/actions (blue)
  ...
  static const lightSystemMessage =
      Color(0xFF252D31); // System message background
  ...
  static const gradient1 = [
    Color(0xFF25D366),
    Color(0xFF066C38)
  ]; // Green gradient for dark theme (unchanged)
  static const gradient2 = [
    Color(0xFF53BDEB),
    Color(0xFF027EB5)
  ]; // Blue gradient (unchanged)

  // Light theme gradients - Updated for better visibility
  static const lightGradient1 = [
    Color(0xFF25D366),
    Color(0xFF056062)
  ]; // Updated green gradient for light theme

  // State colors for interactive elements
  static const rippleLight =
      Color(0x1FFFFFFF); // Changed to white ripple for dark backgrounds
  static const rippleDark = Color(0x1FFFFFFF); // 12% white (unchanged)

  // Overlay colors
  static const overlayLight =
      Color(0xB3131C21); // Updated overlay for light theme
  static const overlayDark =
      Color(0xB330302E); // 70% dark background - unchanged
}
