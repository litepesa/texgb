...
extension ExtendedTheme on BuildContext {
  ...
  WhatsAppThemeExtension get whatsappTheme {
    return Theme.of(this).extension<WhatsAppThemeExtension>()!;
  }
}
...
/// WhatsApp-specific theme extension (synced from whatsapp_messenger repository)
class WhatsAppThemeExtension extends ThemeExtension<WhatsAppThemeExtension> {
  ...
  static const lightMode = WhatsAppThemeExtension(
    circleImageColor: Color(0xFF008069), // WhatsApp green light
    greyColor: Color(0xFF667781), // WhatsApp grey light
    blueColor: Color(0xFF027EB5), // WhatsApp blue light
    langBgColor: Color(0xFFF7F8FA),
    langHightlightColor: Color(0xFFE8E8ED),
    authAppbarTextColor: Color(0xFF008069), // WhatsApp green light
    photoIconBgColor: Color(0xFFF1F1F1),
    photoIconColor: Color(0xFF9DAAB3),
    profilePageBg: Color(0xFFF7F8FA),
    chatTextFieldBg: Colors.white,
    chatPageBgColor: Color(0xFFEFE7DE), // WhatsApp doodle background
    chatPageDoodleColor: Colors.white70,
    senderChatCardBg: Color(0xFFE7FFDB), // WhatsApp sender bubble
    receiverChatCardBg: Color(0xFFFFFFFF),
    yellowCardBgColor: Color(0xFFFFEECC),
    yellowCardTextColor: Color(0xFF13191C),
  );

  static const darkMode = WhatsAppThemeExtension(
    circleImageColor: Color(0xFF00A884), // WhatsApp green dark
    greyColor: Color(0xFF8696A0), // WhatsApp grey dark
    blueColor: Color(0xFF53BDEB), // WhatsApp blue dark
    ...
    chatTextFieldBg: Color(0xFF202C33), // WhatsApp grey background
    chatPageBgColor: Color(0xFF081419), // WhatsApp chat background
    chatPageDoodleColor: Color(0xFF172428),
    senderChatCardBg: Color(0xFF005C4B), // WhatsApp dark sender bubble
    receiverChatCardBg: Color(0xFF202C33), // WhatsApp grey background
    yellowCardBgColor: Color(0xFF222E35),
    yellowCardTextColor: Color(0xFFFFD279),
  );

  @override
  ThemeExtension<WhatsAppThemeExtension> copyWith({
  ...
  @override
  ThemeExtension<WhatsAppThemeExtension> lerp(
      ThemeExtension<WhatsAppThemeExtension>? other, double t) {
    if (other is! WhatsAppThemeExtension) return this;
    return WhatsAppThemeExtension(
